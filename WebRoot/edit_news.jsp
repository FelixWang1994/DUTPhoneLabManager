		...
		<table class="ptable" cellspacing="1" cellpadding="0" border="0"
			...
			<tr onmouseover="this.bgColor='#eeeeee'"
				...
				<td colspan="6">
					...
					&nbsp;
					<a href="edit_news.jsp?page=1"> <jsp:getProperty
							property="firstPageText" name="pageBean" /> </a>
					<a
						href="edit_news.jsp?page=<jsp:getProperty name="pageBean" property="prePage"/>">
						<jsp:getProperty property="prePageText" name="pageBean" /> </a>
					<a
						href="edit_news.jsp?page=<jsp:getProperty name="pageBean" property="nextPage"/>">
						<jsp:getProperty property="nextPageText" name="pageBean" /> </a>
					<a
						href="edit_news.jsp?page=<jsp:getProperty name="pageBean" property="maxPage"/>">
